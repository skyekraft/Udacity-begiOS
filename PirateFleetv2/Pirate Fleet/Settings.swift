...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "Look out! The sea monster you just hit is irate!"
        static let ComputerHitMonster = "Well isn't that good luck? The computer's being chased by a sea monster."
